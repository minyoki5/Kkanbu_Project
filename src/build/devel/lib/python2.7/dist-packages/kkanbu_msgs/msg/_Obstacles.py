...
"""autogenerated by genpy from kkanbu_msgs/Obstacles.msg. Do not edit."""
import codecs
import sys
...
class Obstacles(genpy.Message):
  _md5sum = "c1be7cf51834f4235fe0d0cdd6461ad5"
  _type = "kkanbu_msgs/Obstacles"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','kkanbu_msgs/SegmentObstacle[]','kkanbu_msgs/CircleObstacle[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.circles:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_5d().pack(_x.radius, _x.true_radius, _x.angle, _x.c_distance, _x.min_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kkanbu_msgs.msg.SegmentObstacle()
      ...
      self.circles = []
      for i in range(0, length):
        val1 = kkanbu_msgs.msg.CircleObstacle()
        _v7 = val1.center
        _x = _v7
        start = end
        end += 24
        ...
        (_x.radius, _x.true_radius, _x.angle, _x.c_distance, _x.min_distance,) = _get_struct_5d().unpack(str[start:end])
