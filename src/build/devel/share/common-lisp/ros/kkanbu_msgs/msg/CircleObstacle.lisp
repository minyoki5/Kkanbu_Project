...
(cl:defmethod cl:initialize-instance :after ((m <CircleObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kkanbu_msgs-msg:<CircleObstacle> is deprecated: use kkanbu_msgs-msg:CircleObstacle instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kkanbu_msgs-msg:center-val is deprecated.  Use kkanbu_msgs-msg:center instead.")
  (center m))
...
(cl:defmethod radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kkanbu_msgs-msg:radius-val is deprecated.  Use kkanbu_msgs-msg:radius instead.")
  (radius m))

(cl:ensure-generic-function 'true_radius-val :lambda-list '(m))
(cl:defmethod true_radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kkanbu_msgs-msg:true_radius-val is deprecated.  Use kkanbu_msgs-msg:true_radius instead.")
  (true_radius m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <CircleObstacle>))
...
(cl:ensure-generic-function 'c_distance-val :lambda-list '(m))
(cl:defmethod c_distance-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kkanbu_msgs-msg:c_distance-val is deprecated.  Use kkanbu_msgs-msg:c_distance instead.")
  (c_distance m))

(cl:ensure-generic-function 'min_distance-val :lambda-list '(m))
(cl:defmethod min_distance-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kkanbu_msgs-msg:min_distance-val is deprecated.  Use kkanbu_msgs-msg:min_distance instead.")
  (min_distance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CircleObstacle>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'angle))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'c_distance))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CircleObstacle>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'velocity) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'c_distance) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CircleObstacle>)))
  ...
  "05bb128df3c5085b6180e623f9261236")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CircleObstacle)))
  "Returns md5sum for a message object of type 'CircleObstacle"
  "05bb128df3c5085b6180e623f9261236")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CircleObstacle>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%float64 angle			# Angle of Center [degree]~%float64 c_distance		# Distance from Center [m]~%float64 min_distance		# Min_Distance [m]~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CircleObstacle)))
  "Returns full string definition for message of type 'CircleObstacle"
  (cl:format cl:nil "geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%float64 angle			# Angle of Center [degree]~%float64 c_distance		# Distance from Center [m]~%float64 min_distance		# Min_Distance [m]~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CircleObstacle>))
  ...
  (cl:list 'CircleObstacle
    ...
    (cl:cons ':c_distance (c_distance msg))
